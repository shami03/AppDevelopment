...
function Privacy() {
  return (
    ...
    <p>At <span class="website_name">MINIATURE PLAYER PORTAL</span>, we collect and manage user data according to the following Privacy Policy.</p>
    ...
    <p>We only use your personal information to provide you the <span class="website_name">MINIATURE PLAYER PORTAL</span> services or to communicate with you about the Website or the services.</p>
