  ...
  <div class="footer-items">
    ...
    <div class="border1"></div>
      <ul>
        ...
        <li><a href="mailto:feedback@miniature.com"><AlternateEmailIcon/> contact@wgh.com</a></li>
      </ul> 
